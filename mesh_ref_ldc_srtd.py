...
table_file = open('results_ldc_' + model + '/mesh_ref_ldc_Wi=%.3e_s=%.3e_l1=%.3e_'%(Wi, speed, lambda1) + model + '_srtd.csv', 'w') 
...
for h in h_array:
    ...
    solution = oldroyd_3_LDC_SRTD(h, speed, eta, lambda1, mu1, max_srtd_iters, srtd_tol)
    end_solve = time.time()
