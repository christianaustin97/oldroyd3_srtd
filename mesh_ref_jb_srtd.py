...
(without SUPG). We assume no knowledge of the exact solution, and the convergence
...
table_file = open('results_jb_' + model + '/mesh_ref_jb_Wi=%.3e_s=%.3e_l1=%.3e_'%(Wi, speed, lambda1) + model + '_srtd.csv', 'w') 
