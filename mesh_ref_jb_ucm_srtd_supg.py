...
42 and when you call the solver on line 83
"""
...
table_file = open('mesh_ref_jb_ucm_l1=%.3e_srtd_supg.csv'%lambda1, 'w') 
...
for h in h_array:
    ...
    solution = oldroyd_3_JB_SRTD_SUPG(h, rad, ecc, eta, lambda1, mu1, max_srtd_iters, srtd_tol)
    end_solve = time.time()
